  ...
  return (
    <div>
      <section className='max-padd-container py-16'>
        <Title title1={'Our Expert'} title2={'Blog'} titleStyles={'pb-10'}
        para={"Stay ahead of fashion trends with styling tips, products reviews, and expert advice helping you shop smarter and dress better."}/>
