            ...
            <div className='flex gap-x-5'>
              ...
              <div className='w-1/2 mb-4'>
                <input
                  ...
                  className='w-full mt-1 py1.5 px-3 border-none ring-1 ring-secondary/20 rounded-sm regular-14 bg-white'
                />
              </div>
            </div>
            <div className='mb-4'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex flex-col gap-3'>
            <div className='flex flex-col'>
              ...
              <p className='flexStart gap-x-2'><FaLocationDot />56 M.M. Feeder Road, Belgharia, Kolkata-700056</p>
            </div>
            <div className='flex flex-col'>
