            ...
            <div key={idx} className='text-gray-700 flex flex-col lg:flex-row gap-4 mb-3'>
              <div className='flex flex-[2] gap-x-3'>
                <div className="flexCenter bg-primary rounded">
                  <img src={item.product.image[0]} alt="orderedProductImg" className='max-h-20 max-w-20 object-contain' />
                </div>
                <div className="block w-full">
                    <h5 className="h5 capitalize">{item.product.name}</h5>
          ...
          <div className='flex flex-col lg:flex-row justify-between items-start gap-4 border-t border-gray-300 pt-3'>
            <div className='flex flex-col gap-2'>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex items-center gap-x-2">
                  <h5 className='medium-14'>Phone No:</h5>
